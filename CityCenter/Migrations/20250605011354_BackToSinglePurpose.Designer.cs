...
namespace CityCenter.Migrations
{
    ...
    [Migration("20250605011354_BackToSinglePurpose")]
    partial class BackToSinglePurpose
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CityCenter.Models.ЗаявкаНаАренду", b =>
                {
                    b.Property<int>("ID_Заявки")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ID_Заявки"));

                    b.Property<int>("ID_Пользователя")
                        .HasColumnType("int");

                    b.Property<int>("ID_Помещения")
                        .HasColumnType("int");

                    b.Property<DateTime>("ДатаЗаявки")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ФотоОплаты")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ID_Заявки");

                    b.HasIndex("ID_Пользователя");

                    b.HasIndex("ID_Помещения");

                    b.ToTable("ЗаявкиНаАренду");
                });
            ...
            modelBuilder.Entity("CityCenter.Models.Помещения", b =>
                {
                    ...
                    b.Property<string>("СсылкаНаМагазин")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CityCenter.Models.SvgRoom", b =>
                {
                    b.HasOne("CityCenter.Models.Помещения", "Помещение")
                        .WithMany("SvgRooms")
                        .HasForeignKey("StoreId")
                        .HasPrincipalKey("Расположение")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Помещение");
                });
            ...
            modelBuilder.Entity("CityCenter.Models.ЗаявкаНаАренду", b =>
                {
                    b.HasOne("CityCenter.Models.Пользователи", "Пользователь")
                        .WithMany()
                        .HasForeignKey("ID_Пользователя")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CityCenter.Models.Помещения", "Помещение")
                        .WithMany()
                        .HasForeignKey("ID_Помещения")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CityCenter.Models.Помещения", b =>
                {
                    b.HasOne("CityCenter.Models.НазначенияПомещений", "IdНазначенияNavigation")
                        ...
                        .HasConstraintName("FK_Помещения_Назначения");
